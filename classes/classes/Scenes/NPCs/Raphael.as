...
private function meetRaphaelPtII():void {
	...
	else simpleChoices("Let Him Go", letRaphaelGoFirstMeeting, "Slap", RaphaelFirstMeetingSLAP, "Rape", (player.lust >= 0 && player.hasCock() && player.cor >= (0 - player.corruptionTolerance())) ? rapeRaphael : null, "", null, "", null);
}
